...
Link to video transcript [here](chapter10.1_transcript.qmd). Tradução para o português disponível [aqui](chapter10.1_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter10.2_transcript.qmd). Tradução para o português disponível [aqui](chapter10.2_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter10.3_transcript.qmd). Tradução para o português disponível [aqui](chapter10.3_transcript_portugues.qmd#sec-section1).
...
```{r, echo=FALSE}
library("vembedr")
embed_url("https://www.youtube.com/watch?v=vE9wdqPZ0Z0")
```

Link to video transcript [here](chapter10.4_transcript.qmd).

------------------------------------------------------------------------

# 10.5 Collaboration for LMIC Researchers {#sec-section5}
...
Link to video transcript [here](chapter10.6_transcript.qmd). Tradução para o português disponível [aqui](chapter10.6_transcript_portugues.qmd#sec-section1).
