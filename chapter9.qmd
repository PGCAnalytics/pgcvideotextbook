...
Link to video transcript [here](chapter9.1_transcript.qmd). Tradução para o português disponível [aqui](chapter9.1_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter9.2_transcript.qmd). Tradução para o português disponível [aqui](chapter9.2_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter9.4_transcript.qmd#sec-video1). Tradução para o português disponível [aqui](chapter9.4_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter9.4_transcript.qmd#sec-video2). Tradução para o português disponível [aqui](chapter9.4_transcript_portugues.qmd#sec-section2).
