...
Link to video transcript [here](chapter2.1_transcript.qmd). Tradução para o português disponível [aqui](chapter2.1_transcript_portugues.qmd#sec-section1).
...
Link to video transcript [here](chapter2.3_transcript.qmd#sec-origins). Tradução para o português disponível [aqui](chapter2.3_transcript_portugues.qmd#sec-section1).
